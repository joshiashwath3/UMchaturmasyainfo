...
public class BusDetails extends AppCompatActivity {
    ...
    void setItems(){
        ...
        try {
            ...
            JSONArray jsonArray_country = jsonObject_country.getJSONArray("um_bus");
            for (int i = 0; i < jsonArray_country.length(); i++) {
                ...
                if (jsonObject.getString("cityName").equals(nameofCity)){
                    JSONArray jsonArray_train = jsonObject.getJSONArray("bus");
                    ...
                    for (int j = 0; j < jsonArray_train.length(); j++) {
                        ...
                        Train item = new Train(
                                jsonObject_train.getString("busNameNo"),
                                jsonObject_train.getString("busACNONAC"),
                                jsonObject_train.getString("busFromTo"),
                                jsonObject_train.getString("busTimeFromToDur")
                        );
                        listitems.add(item);
        ...
        if (id == android.R.id.home) {
            ...
            if (id == R.id.action_exit) {
                ...
                if (id == R.id.action_about) {
                    startActivity(new Intent(BusDetails.this,AbstractMethodError.class));
                    return true;
                }
            }
        }
